...
package com.salesvision.schedularservice;
...
import com.salesvision.salesvision.service.*;
...
//import com.salesvision.schedularservice.model.*;
...
public class SchedularService {
    ...
    @Autowired
    private SalesVisionQueryExecutorService executorService;
    ...
    public void runScript(){
        UpdateTaskDbRequest updateTaskDbRequest = new UpdateTaskDbRequest();
        int result = executorService.executeUpdateTaskDB(updateTaskDbRequest);
        logger.debug("Schedular execute with return value:: "+result);
