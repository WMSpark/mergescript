...
public class SalesVisionQueryExecutorServiceImpl implements SalesVisionQueryExecutorService {
    ...
    @Override
    public Integer executeUpdateTaskDB(UpdateTaskDbRequest updateTaskDbRequest) {
        Map<String, Object> params = new HashMap<>(0);


        return queryExecutor.executeNamedQueryForUpdate("UpdateTaskDB", params);
    }
    ...
    @Transactional(value = "SalesVisionTransactionManager", readOnly = true)
    @Override
    public Page<ChartsaDataResponse> executeChartsaData(Pageable pageable) {
        Map<String, Object> params = new HashMap<>(0);


        return queryExecutor.executeNamedQuery("ChartsaData", params, ChartsaDataResponse.class, pageable);
    }

    @Transactional(value = "SalesVisionTransactionManager", timeout = 300, readOnly = true)
    @Override
    public void exportChartsaData(ExportOptions exportOptions, Pageable pageable, OutputStream outputStream) {
        Map<String, Object> params = new HashMap<>(0);


        QueryProcedureInput<ChartsaDataResponse> queryInput = new QueryProcedureInput<>("ChartsaData", params, ChartsaDataResponse.class);
