 ...
 * @see Users
 */
@Service("SalesVision.UsersService")
@Validated
@EntityService(entityClass = Users.class, serviceId = "SalesVision")
public class UsersServiceImpl implements UsersService {
    ...
    @Autowired
    @Qualifier("SalesVision.UsersDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service SalesVision for table Users to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service SalesVision for table Users to {} format", options.getExportType());
