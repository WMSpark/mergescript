...
import com.salesvision.salesvision.service.UsersService;
 ...
 * @see Users
 */
@RestController("SalesVision.UsersController")
@Api(value = "UsersController", description = "Exposes APIs to work with Users resource.")
@RequestMapping("/SalesVision/Users")
public class UsersController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UsersController.class);

    @Autowired
	@Qualifier("SalesVision.UsersService")
