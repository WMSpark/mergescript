...
public class RepsController {
    ...
    @RequestMapping(value="/{id:.+}/badgeses", method=RequestMethod.GET)
    ...
    @RequestMapping(value="/{id:.+}/repsesForReportingHead", method=RequestMethod.GET)
    ...
    @RequestMapping(value="/{id:.+}/rewardses", method=RequestMethod.GET)
