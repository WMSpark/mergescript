...
public class QueryExecutionController {
    ...
    @RequestMapping(value = "/queries/getDealStatus", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/queries/getDealStatus/export", method = RequestMethod.POST)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    ...
    @RequestMapping(value = "/queries/getExistingCustomers", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    ...
    @RequestMapping(value = "/queries/getExistingCustomers/export", method = RequestMethod.POST)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    ...
    @RequestMapping(value = "/queries/UpdateTaskDB", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "updating daily basis")
    public IntegerWrapper executeUpdateTaskDB(@Valid @RequestBody UpdateTaskDbRequest updateTaskDbRequest, HttpServletRequest _request) {
        LOGGER.debug("Executing named query: UpdateTaskDB");
        Integer _result = queryService.executeUpdateTaskDB(updateTaskDbRequest);
        LOGGER.debug("got the result for named query: UpdateTaskDB, result:{}", _result);
        return new IntegerWrapper(_result);
    }

    @RequestMapping(value = "/queries/updateQuoteStatusConverted", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    ...
    @RequestMapping(value = "/queries/ChartsaData", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "charts Data")
    public Page<ChartsaDataResponse> executeChartsaData(Pageable pageable, HttpServletRequest _request) {
        LOGGER.debug("Executing named query: ChartsaData");
        Page<ChartsaDataResponse> _result = queryService.executeChartsaData(pageable);
        LOGGER.debug("got the result for named query: ChartsaData, result:{}", _result);
        return _result;
    }

    @ApiOperation(value = "Returns downloadable file url for query ChartsaData")
    @RequestMapping(value = "/queries/ChartsaData/export", method = RequestMethod.POST)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportChartsaData(@RequestBody ExportOptions exportOptions, Pageable pageable) {
        LOGGER.debug("Exporting named query: ChartsaData");

        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = "ChartsaData";
        }
        exportedFileName += exportOptions.getExportType().getExtension();

        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName,
                        outputStream -> queryService.exportChartsaData( exportOptions, pageable, outputStream));

        return new StringWrapper(exportedUrl);
    }

    @RequestMapping(value = "/queries/getRepsCount", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Get representatives for manager")
    ...
    @RequestMapping(value = "/queries/getRepsCount/export", method = RequestMethod.POST)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    ...
    @RequestMapping(value = "/queries/getSalesSum", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    ...
    @RequestMapping(value = "/queries/getTopPerformers", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    ...
    @RequestMapping(value = "/queries/getTopPerformers/export", method = RequestMethod.POST)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    ...
    @RequestMapping(value = "/queries/getTopSellingSales", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    ...
    @RequestMapping(value = "/queries/getTopSellingSales/export", method = RequestMethod.POST)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
