...
package com.salesvision.testjavaservice;
...
//import com.salesvision.testjavaservice.model.*;
...
public class TestJavaService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TestJavaService.class);
